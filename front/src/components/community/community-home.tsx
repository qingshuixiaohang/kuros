...
const bannerSlides = [
  { alt: "鸣潮 2.6 版本前瞻", description: "版本情报 · 攻略与漂泊者记录", src: "/art/修-2.6版本PV预告图 5K.png", title: "鸣潮" },
  { alt: "心灵海男漂地图", description: "探索地图 · 标记你的下一处回响", src: "/art/修-心灵海 男漂地图.png", title: "心灵海" },
  { alt: "嘉贝莉娜角色唤取动画", description: "角色图鉴 · 记录每一次共鸣相遇", src: "/art/修-嘉贝莉娜  唤取动画.png", title: "嘉贝莉娜" },
];
