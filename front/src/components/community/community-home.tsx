...
function Banner() { return <section className="community-banner" id="top"><Image alt="鸣潮 2.6 版本前瞻" className="community-banner-image" fill priority sizes="(max-width: 720px) 100vw, 880px" src="/art/修-2.6版本PV预告图 5K.png" /><div className="banner-copy"><div className="banner-logo">鸣潮<small>WUTHERING WAVES</small></div><p>版本情报 · 攻略与漂泊者记录</p></div></section>; }
